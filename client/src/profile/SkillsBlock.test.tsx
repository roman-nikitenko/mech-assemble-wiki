...
const rows: SkillNodeRow[] = [
  { id: "r", parentId: null, name: "Stackable", description: "buff", appearanceLevel: 1, type: "Normal", sortOrder: 0, repeatable: true, linkedWeaponId: null, linkedMechId: null, initialAtTier: null },
  { id: "n", parentId: null, name: "Single", description: "once", appearanceLevel: 1, type: "Normal", sortOrder: 1, repeatable: false, linkedWeaponId: null, linkedMechId: null, initialAtTier: null },
];
