...
import { droneTypesRouter } from "./routes/drone-types";
import { aircraftRouter } from "./routes/aircraft";
import { aircraftAttributesRouter } from "./routes/aircraft-attributes";
import { weaponsRouter } from "./routes/weapons";
import { accessoriesRouter } from "./routes/accessories";
import { accessorySetsRouter } from "./routes/accessory-sets";
import { arsenalSetsRouter } from "./routes/arsenal-sets";
import { arsenalPiecesRouter } from "./routes/arsenal-pieces";
import { hiddenAchievementsRouter } from "./routes/hidden-achievements";
import { moduleQualitiesRouter } from "./routes/module-qualities";
...
app.use("/api/drone-types", droneTypesRouter);
app.use("/api/aircraft", aircraftRouter);
app.use("/api/aircraft-attributes", aircraftAttributesRouter);
app.use("/api/weapons", weaponsRouter);
app.use("/api/accessories", accessoriesRouter);
app.use("/api/accessory-sets", accessorySetsRouter);
app.use("/api/arsenal-sets", arsenalSetsRouter);
app.use("/api/arsenal-pieces", arsenalPiecesRouter);
app.use("/api/hidden-achievements", hiddenAchievementsRouter);
app.use("/api/module-qualities", moduleQualitiesRouter);
